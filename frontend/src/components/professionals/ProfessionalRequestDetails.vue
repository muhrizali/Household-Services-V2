        ...
        <div class="card-body">
            <div v-if="serviceRequestFound">
                ...
                <div class="flex justify-end gap-2">
                    <RouterLink v-if="serviceRequest.status === 'REQUESTED'" :to="{ name: 'professional_request_accept', params: { 'rid': serviceRequest.id } }">
                        <button class="btn btn-sm btn-success">ACCEPT</button>
                    </RouterLink>
                    <RouterLink v-else-if="serviceRequest.status === 'ASSIGNED'" :to="{ name: 'professional_request_reject', params: { 'rid': serviceRequest.id } }">
