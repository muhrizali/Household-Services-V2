    ...
    <nav class="navbar bg-primary">
      ...
      <div class="navbar-center">
        <ul class="menu menu-lg menu-horizontal">
          ...
          <li>
            <RouterLink :to="{ name: 'customer_home', params: { id: customerID } }" class="btn btn-ghost">Home
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="{ name: 'customer_search' }" class="btn btn-ghost">Search</RouterLink>
          </li>
        </ul>
      </div>
      <div class="navbar-end">
        <RouterLink :to="{ name: 'customer_profile_details', params: { id: customerID } }"
          class="btn btn-ghost text-lg"> Profile </RouterLink>
